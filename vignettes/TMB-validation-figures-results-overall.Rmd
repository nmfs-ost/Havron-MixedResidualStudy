...
```{r, test-comparison, echo = FALSE, caption = "Type I Error for correctly specified models from goodness-of-fit normality tests: Anderson-Darling, Kolmogorov-Smirnov, and Lilliefors."}
...
```{r, method-comparison, echo = FALSE, caption = "Type I Error for correctly specified models compared across residual calculation methods."}
df.err <- pvals %>% dplyr::filter(., version == "h0" & 
                          (model == "randomwalk" | model == "spatial") &
                          (test == "Kolmogorov- Smirnov" | 
                             test == "Autocorrelation" |
...
```{r, misp-obs-model-lmm, echo = FALSE, caption = "LMM: Residual calculation methods compared for Type I Error and Power for Mis-specified LMM Data Models under the Kolmogorov-Smirnov normality Test."}
...
## Missing RE Model
```{r, miss-re-lmm, echo = FALSE, caption = "LMM: Residual calculation methods compared for Type I Error and Power for Missing Random Effects LMM Models under the Kolmogorov-Smirnov normality Test and Correlation Tests (Durbin-Watson Autocorrelation and Moran's I Spatial Autocorrelation)."}
...
```{r, miss-re-glmm, echo = FALSE, caption = "GLMM: Residual calculation methods compared for Type I Error and Power for Missing Random Effects GLMM Models under the Kolmogorov-Smirnov normality Test and Correlation Tests (Durbin-Watson Autocorrelation and Moran's I Spatial Autocorrelation)."}
...
```{r, misp-re-lmm, echo = FALSE, caption = "LMM: Residual calculation methods compared for Type I Error and Power for Mis-specified Random Effects LMM Models under the Kolmogorov-Smirnov normality Test and Correlation Tests (Durbin-Watson Autocorrelation and Moran's I Spatial Autocorrelation)."}
...
```{r, misp-re-glmm, echo = FALSE, caption = "GLMM: Residual calculation methods compared for Type I Error and Power for Mis-specified Random Effects GLMM Models under the Kolmogorov-Smirnov normality Test and Correlation Tests (Durbin-Watson Autocorrelation and Moran's I Spatial Autocorrelation)."}
