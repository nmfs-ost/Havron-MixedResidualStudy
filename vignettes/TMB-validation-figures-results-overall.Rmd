...
```{r, misp-obs-model-lmm, echo = FALSE, message = FALSE, warning = FALSE, fig.height = 8, caption = "LMM: Residual calculation methods compared for Type I Error and Power for Mis-specified LMM Data Models under the Kolmogorov-Smirnov normality Test."}
...
```{r, miss-re-lmm, echo = FALSE, message = FALSE, warning = FALSE, fig.height = 12, caption = "LMM: Residual calculation methods compared for Type I Error and Power for Missing Random Effects LMM Models under the Kolmogorov-Smirnov normality Test and Correlation Tests (Durbin-Watson Autocorrelation and Moran's I Spatial Autocorrelation)."}
df.corr <- dplyr::filter(pvals,( model == "spatial" | model == "randomwalk" | model == 'phylo') & 
                           method != "Unconditional ecdf, Not Rotated" & 
                           method != "Conditional ecdf, Not Rotated")  
...
```{r, miss-re-glmm, echo = FALSE, message = FALSE, warning = FALSE, fig.height = 10, caption = "GLMM: Residual calculation methods compared for Type I Error and Power for Missing Random Effects GLMM Models under the Kolmogorov-Smirnov normality Test and Correlation Tests (Durbin-Watson Autocorrelation and Moran's I Spatial Autocorrelation)."}
df.corr %>% dplyr::filter(., type == "GLMM" & method != "Unconditional ecdf, Not Rotated" & 
                           method != "Conditional ecdf, Not Rotated" ) %>% 
  plot.err.pow(., misp.filter = c("Correct",  "Missing RE"), test.filter = 
...
```{r, misp-re-lmm, echo = FALSE, message = FALSE, warning = FALSE, fig.height = 12, caption = "LMM: Residual calculation methods compared for Type I Error and Power for Mis-specified Random Effects LMM Models under the Kolmogorov-Smirnov normality Test and Correlation Tests (Durbin-Watson Autocorrelation and Moran's I Spatial Autocorrelation)."}
df.corr %>% dplyr::filter(., type == "LMM" & method != "Unconditional ecdf, Not Rotated" & 
                           method != "Conditional ecdf, Not Rotated" ) %>% 
...
```{r, misp-re-glmm, echo = FALSE, message = FALSE, warning = FALSE, fig.height = 10, caption = "GLMM: Residual calculation methods compared for Type I Error and Power for Mis-specified Random Effects GLMM Models under the Kolmogorov-Smirnov normality Test and Correlation Tests (Durbin-Watson Autocorrelation and Moran's I Spatial Autocorrelation)."}
df.corr %>% dplyr::filter(., type == "GLMM" & method != "Unconditional ecdf, Not Rotated" & 
                           method != "Conditional ecdf, Not Rotated" ) %>% 
  plot.err.pow(., misp.filter = c("Correct",  "Misp. RE Model"), test.filter = c("Autocorrelation",  "Kolmogorov- Smirnov") )
```
