...
tbl.err.pow(pval.df.true, 
        caption = "LMM Temporal Correlation Model. Type I error rates and Power evaluated for each analytical and simulation method for theoretical residuals. Results are partitioned out by model mis-specification (from left to right), test type and method (top to bottom).")
```

```{r, randomwalk-lmm-est, echo = FALSE, message = FALSE, warning = FALSE, fig.width = 8}

tbl.err.pow(pval.df.est, 
        caption = "LMM Temporal Correlation Model. Type I error rates and Power evaluated for each analytical and simulation method for estimated residuals. Results are partitioned out by model mis-specification (from left to right), test type and method (top to bottom).")
```
...
tbl.err.pow(pval.df.est,
        caption = "GLMM Temporal Correlation Model. Type I error rates and Power evaluated for each analytical and simulation method for estimated residuals. Results are partitioned out by model mis-specification (from left to right), test type and method (top to bottom).")
```
...
tbl.err.pow(pval.df.true, 
        caption = "LMM Spatial Model. Type I error rates and Power evaluated for each analytical and simulation method for theoretical residuals. Results are partitioned out by model mis-specification (from left to right), test type and method (top to bottom).")
```

```{r, spatial-results-lmm-est, echo = FALSE, message = FALSE, warning = FALSE, fig.width = 8}

tbl.err.pow(pval.df.est, 
        caption = "LMM Spatial Model. Type I error rates and Power evaluated for each analytical and simulation method for estimated residuals. Results are partitioned out by model mis-specification (from left to right), test type and method (top to bottom).")
```
...
tbl.err.pow(pval.df.true,
        caption = "GLMM Spatial Model. Type I error rates and Power evaluated for each analytical and simulation method for theoretical residuals. Results are partitioned out by model mis-specification (from left to right), test type and method (top to bottom).")
```

```{r, spatial-results-glmm-est, echo = FALSE, message = FALSE, warning = FALSE, fig.width = 8}

tbl.err.pow(pval.df.est,
        caption = "GLMM Spatial Model. Type I error rates and Power evaluated for each analytical and simulation method for estimated residuals. Results are partitioned out by model mis-specification (from left to right), test type and method (top to bottom).")
```
...
tbl.err.pow(pval.df.true, 
        caption = "LMM Phylogenetic Model. Type I error rates and Power evaluated for each analytical and simulation method for theoretical residuals. Results are partitioned out by model mis-specification (from left to right, test type and method (top to bottom).")
```

```{r, phylo-results-lmm-est, echo = FALSE, message = FALSE, warning = FALSE, fig.width = 8}

tbl.err.pow(pval.df.est, 
        caption = "LMM Phylogenetic Model. Type I error rates and Power evaluated for each analytical and simulation method for estimated residuals. Results are partitioned out by model mis-specification (from left to right), test type and method (top to bottom).")
```
...
tbl.err.pow(pval.df.true,
        caption = "GLMM Phylogenetic Model. Type I error rates and Power evaluated for each analytical and simulation method for theoretical residuals. Results are partitioned out by model mis-specification (from left to right), test type and method (top to bottom).")
```

```{r, phylo-results-glmm-est, echo = FALSE, message = FALSE, warning = FALSE, fig.width = 8}

tbl.err.pow(pval.df.est,
        caption = "GLMM Phylogenetic Model. Type I error rates and Power evaluated for each analytical and simulation method for estimated residuals. Results are partitioned out by model mis-specification (from left to right), test type and method (top to bottom).")
```
