...
- [docs](https://github.com/Cole-Monnahan-NOAA/mixed_resids/tree/main/docs):
  Rmarkdown file containing [Placeholder Figures and
  Tables](https://github.com/Cole-Monnahan-NOAA/mixed_resids/tree/main/docs/TMB-validation-tables-figures.pdf)
  document
