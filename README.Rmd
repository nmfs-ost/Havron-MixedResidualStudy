...
- [Pkgdown Repo](https://github.com/nmfs-ost/Havron-MixedResidualStudy):
  ...
  - Figures:
    ...
    - [Overall Results](https://nmfs-ost.github.io/Havron-MixedResidualStudy/articles/TMB-validation-figures-results-overall.html)
    - [Temporal Results](https://nmfs-ost.github.io/Havron-MixedResidualStudy/articles/TMB-validation-figures-results-randomwalk.html)
    - [Spatial Results](https://nmfs-ost.github.io/Havron-MixedResidualStudy/articles/TMB-validation-figures-results-spatial.html)
    - [Phylogenetic Results](https://nmfs-ost.github.io/Havron-MixedResidualStudy/articles/TMB-validation-figures-results-phylo.html)
  -[OSA Tutorial](https://nmfs-ost.github.io/Havron-MixedResidualStudy/articles/TMB-validation-tutorial.html)
